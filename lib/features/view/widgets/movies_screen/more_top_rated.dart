...
class MoreTopRated extends StatelessWidget {
  MoreTopRated({super.key});
      ...
      appBar: AppBar(
        leading: IconButton(
            onPressed: () {
              ...
              controller.getMoreTopRatedMovies(1);
            },
            icon: const Icon(
              Icons.arrow_back,
              color: ThemeColor.white,
            )),
        title: CustomText.bodyMedium('Top Rated Movies', context: context),
      ),
            ...
            children: [
              ...
              Padding(
                ...
                child: NumberPaginator(
                  ...
                  onPageChange: (index) =>
                      controller.getMoreTopRatedMovies(index + 1),
